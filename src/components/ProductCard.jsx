    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-white/5">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-1.5">
          {product.isNew && (
            <span className="bg-brand-accent text-white text-[10px] font-bold px-2.5 py-1 rounded-md uppercase tracking-wide">
              New
            </span>
          )}
          {discount && (
      ...
      <div className="p-4">
        ...
        <div className={`text-[11px] font-medium mb-3 ${product.inStock ? 'text-green-400' : 'text-red-400'}`}>
        ...
        <button
          ...
          className="w-full bg-brand-accent text-white text-sm font-semibold py-2.5 rounded-lg disabled:opacity-40 disabled:cursor-not-allowed hover:opacity-90 transition-opacity"
        >
